...
from lorebinders.models import AnalysisResult, CategoryTarget, Chapter, AgentDeps
...
async def test_run_analysis_batch_enforces_category_consistency() -> None:
    ...
    with patch("lorebinders.agent.analysis.run_agent_async", return_value=mock_results):
